/**
 * Created by huangjiaroro on 2018/1/22.
 */
(function ($) {
    //自定义下拉控件
    $.fn.spinnerBox = function (options, param) {
        ...
        if (typeof options == 'string') {
            ...
            } else if (window.localStorage.dic_data) { //从字典dic_data 中获取相应的列表值 modify 2017=09-29 huangjiaroro
...
/* use:
 1.根据url去获取数据
 $.spinnerBox({url:"/spinner/school"})

 2.根据code去获取字典基础数据：
 $.spinnerBox({controlCode:"school"})
 */